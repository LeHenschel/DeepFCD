...
def save_to_nii(inputdir, realnii, subjid, outname):
...
parser.add_argument("-sid", "--sid", help="Subject ID")

args=parser.parse_args()

save_to_nii(args.inputdir, args.realnii, args.sid, args.outname)
